...
echo "server.ssl.key-store=./ConfigServer/src/main/resources/ssl/$KEYSTORE_NAME" >> ../application.properties;
...
echo "server.ssl.trust-store=./ConfigServer/src/main/resources/ssl/truststore.p12" >> ../application.properties
