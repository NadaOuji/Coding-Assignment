...
echo "server.ssl.key-store=./TransactionService/src/main/resources/ssl/$KEYSTORE_NAME" >> ../application.properties;
...
echo "server.ssl.trust-store=./TransactionService/src/main/resources/ssl/truststore.p12" >> ../application.properties
