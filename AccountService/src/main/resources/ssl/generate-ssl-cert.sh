...
echo "server.ssl.key-store=./AccountService/src/main/resources/ssl/$KEYSTORE_NAME" >> ../application.properties;
...
echo "server.ssl.trust-store=./AccountService/src/main/resources/ssl/truststore.p12" >> ../application.properties
